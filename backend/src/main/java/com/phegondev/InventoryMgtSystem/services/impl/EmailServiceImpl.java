...
public class EmailServiceImpl implements EmailService {
    ...
    private String buildManagerWelcomeEmailContent(String managerName, String email, String temporaryPassword,
            String loginUrl) {
        return """
                <!DOCTYPE html>
                <html>
    ...
    public void sendPasswordResetEmail(String toEmail, String userName, String resetToken, String resetUrl) {
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(toEmail);
            helper.setSubject("Reset Your Password - Inventera");

            String emailContent = buildPasswordResetEmailContent(userName, resetToken, resetUrl);
            helper.setText(emailContent, true);
    ...
    private String buildPasswordResetEmailContent(String userName, String resetToken, String resetUrl) {
        String resetLink = resetUrl + "/reset-password?token=" + resetToken;
        ...
        return """
                ...
                <body>
                    ...
                    <div class="content">
                        ...
                        <p>We received a request to reset your password for your Inventera account.</p>
                        ...
                        <div class="warning">
                            ...
                            <ul>
                                <li>This link will expire in <strong>15 min</strong></li>
