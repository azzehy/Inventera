...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: "Gestion des utilisateurs", path: "/UserManagementPage", icon: <LucideIcons.Users size={20} />, auth: isAdmin },
    ...
    { name: "Déconnexion", path: "/login", icon: <LucideIcons.LogOut size={20} />, auth: isAuth, action: logout },
  ];
